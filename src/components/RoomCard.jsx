  ...
  return (
    ...
    >
      <div className="relative h-24 overflow-hidden bg-gradient-to-br from-purple-600/30 via-gray-700/80 to-gray-800">
        ...
        <div className="absolute left-4 top-4 flex h-10 w-10 items-center justify-center rounded-lg bg-purple-600/50">
        ...
        <div className="mt-3 flex items-center gap-4 text-sm text-gray-400">
          <span className="flex items-center gap-1.5">
            <svg className="h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 3.75a.75.75 0 01.75.75v.44l7.124-4.185a.75.75 0 011.126.65v14.47a.75.75 0 01-1.126.65L9.75 18.69v.44a.75.75 0 01-1.5 0V4.5A.75.75 0 019 3.75z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
            {room.sensorCount ?? 0} {room.sensorCount === 1 ? 'sensor' : 'sensores'}
          </span>
        </div>
      </div>
    </div>
